...
/**
 * Google 브랜드 마크. 공통 아이콘(`components/common/icons`)과 달리 브랜드 가이드가 색을 정하므로
 * 토큰이 아닌 지정 색을 그대로 쓴다. 근거: docs/AuthSpec.md 4.1.
 */
export const GoogleMarkIcon = ({ size = 18 }: IconProps) => (
